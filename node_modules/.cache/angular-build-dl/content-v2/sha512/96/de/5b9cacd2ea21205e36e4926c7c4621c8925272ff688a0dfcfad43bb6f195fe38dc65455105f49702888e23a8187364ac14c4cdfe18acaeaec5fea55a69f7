...
const routes = [
    ...
    { path: 'auth', loadChildren: () => __webpack_require__.e(/*! import() | auth-auth-module */ "auth-auth-module").then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "./src/app/auth/auth.module.ts")).then(m => m.AuthPageModule) },
    {
        path: 'places',
...
let AuthGuard = class AuthGuard {
    ...
    canLoad(route, segments) {
        return this.authService.userIsAuthenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(isAuthenticated => {
            if (!isAuthenticated) {
...
let AuthService = class AuthService {
    ...
    autoLogin() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(_capacitor_core__WEBPACK_IMPORTED_MODULE_5__["Plugins"].Storage.get({ key: 'authData' })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(storedData => {
            ...
            const user = new _user_model__WEBPACK_IMPORTED_MODULE_7__["User"](parsedData.userId, parsedData.displayName, parsedData.email, parsedData.token, expirationTime, parsedData.idToken);
            return user;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            if (user) {
    ...
    signup(email, password, displayName) {
        return this.http.post(`https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=${_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].firebaseAPIKey}`, { email, password, displayName, returnSecureToken: true }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(this.setUserData.bind(this)));
    }
    updateUser(id, displayName, email, password, photoUrl) {
        if (password && password != "") {
            return this.http.post(`https://identitytoolkit.googleapis.com/v1/accounts:update?key=${_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].firebaseAPIKey}`, { idToken: id, displayName: displayName, photoUrl: photoUrl, email: email, password: password, returnSecureToken: true }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(this.logout.bind(this)));
        }
...
class User {
    constructor(id, displayName, email, _token, tokenExpirationDate, idToken) {
        this.id = id;
...
/* harmony import */ var _map_modal_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./map-modal.service */ "./src/app/shared/map-modal/map-modal.service.ts");
...
let MapModalComponent = class MapModalComponent {
    constructor(modalCtrl, renderer, mapModalService) {
...
MapModalComponent.propDecorators = {
    mapElementRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['map', { static: null },] }],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapModalService", function() { return MapModalService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
...
let MapModalService = class MapModalService {
    ...
    getGoogleGeoLocation() {
        return this.http
            .post(`https://www.googleapis.com/geolocation/v1/geolocate?key=${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].googleMapsAPIKey}`, Object.assign({}, this.geoLocationReqBody));
    }
    ...
    //   }
    getAddress(coord) {
        return this.http.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${coord.lat},${coord.lng}&key=${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].googleMapsAPIKey}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(geoData => {
    ...
    getStaticMapImageURL(lat, lng, zoom) {
        return `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${lng}&zoom=${zoom}&size=500x300&maptype=roadmap&markers=color:red%7Clabel:S%7C${lat},${lng}&key=${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].googleMapsAPIKey}`;
    }
};
MapModalService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"] }
];
MapModalService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], MapModalService);
...
let ImagePickerComponent = class ImagePickerComponent {
    constructor(platform, actionSheetCtrl) {
        this.platform = platform;
...
ImagePickerComponent.propDecorators = {
    filePicker: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['filePicker', { static: false },] }],
    imagePick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"] }],
    selectedImage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
...
/* harmony import */ var _map_modal_map_modal_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../map-modal/map-modal.service */ "./src/app/shared/map-modal/map-modal.service.ts");
...
let LocationPickerComponent = class LocationPickerComponent {
    constructor(modalCtrl, mapModalService, actionSheetCtrl, alertCtrl) {
        this.modalCtrl = modalCtrl;
        this.mapModalService = mapModalService;
        this.actionSheetCtrl = actionSheetCtrl;
        this.alertCtrl = alertCtrl;
        this.locationPick = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.pickedLocation = { address: null, staticMapImageUrl: null, lat: null, lng: null };
    ...
    locateUsers() {
        this.mapModalService.getGoogleGeoLocation().subscribe(geoPosition => {
            ...
            this.mapModalService.getAddress(this.pickedLocation).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(address => {
                this.pickedLocation.address = address;
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(this.mapModalService.getStaticMapImageURL(this.pickedLocation.lat, this.pickedLocation.lng, 14));
    ...
    openMap() {
        this.modalCtrl.create({ component: _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_3__["MapModalComponent"] }).then(modalEl => {
            modalEl.onDidDismiss().then(modalData => {
                ...
                this.isLoading = true;
                this.mapModalService.getAddress(modalData.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(address => {
                    this.pickedLocation.address = address;
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(this.mapModalService.getStaticMapImageURL(this.pickedLocation.lat, this.pickedLocation.lng, 14));
                })).subscribe(staticImageUrl => {
                    this.pickedLocation.staticMapImageUrl = staticImageUrl;
...
LocationPickerComponent.propDecorators = {
    ...
    selectedLocationImage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
