      ...
      var AccountPage = /*#__PURE__*/function () {
        ...
        _createClass(AccountPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.authService.user.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).subscribe(function (user) {
              _this.user = user;
